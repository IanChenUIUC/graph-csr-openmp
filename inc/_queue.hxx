 ...
 */
template <class I> class DequeView
{
#pragma region TYPES
  protected:
...
#pragma region CONSTRUCTORS
  public:
     ...
     */
    DequeView(I xb, I xe) : xb(xb), xe(xe), ib(xb), ie(xb), n(0)
    {
    }
#pragma endregion
};
 ...
 */
template <class I> inline auto deque_view(I xb, I xe)
{
 ...
 * @tparam I iterator type of the buffer used to store the elements
 */
template <class I> class UnsizedDequeView
{
#pragma region TYPES
  protected:
    using T = typename iterator_traits<I>::value_type;
...
#pragma region CONSTRUCTORS
  public:
     ...
     * @param xe end iterator of the buffer
     */
    UnsizedDequeView(I xb, I xe) : xb(xb), xe(xe), ib(xb), ie(xb)
    {
    }
#pragma endregion
};
 ...
 * @returns the deque view
 */
template <class I> inline auto unsized_deque_view(I xb, I xe)
{
