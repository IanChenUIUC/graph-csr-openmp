 ...
 */
template <size_t SIZE> class FixedArenaAllocator
{
...
#pragma region CONSTRUCTORS
  public:
     ...
     */
    FixedArenaAllocator(void *pool, size_t capacity) : pool(pool), capacity(capacity), used(0)
    {
 ...
 */
template <class T, size_t ALIGN = 4096> inline constexpr size_t bytesof(size_t N)
{
