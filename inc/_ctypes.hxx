...
#pragma region COMPARISION OPERATORS
    friend inline bool operator==(None l, None r) noexcept
    {
        return true;
    }
    template <class T> friend inline bool operator==(None l, const T &r) noexcept
    {
        return false;
    }
    template <class T> friend inline bool operator==(const T &l, None r) noexcept
    {
        return false;
    }
#pragma endregion
...
#pragma region STREAM OPERATORS
    friend inline istream &operator>>(istream &a, None &x) noexcept
    {
        return a;
    }
    friend inline ostream &operator<<(ostream &a, None x) noexcept
    {
        return a;
    }
#pragma endregion
...
#pragma region CONSTRUCTORS
     ...
     */
    template <class T> explicit None(T _)
    {
    }
#pragma endregion
};
 ...
 */
template <class T> struct ShowType;
