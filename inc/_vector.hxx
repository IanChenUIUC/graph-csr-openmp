 ...
 */
template <class TA, class TX, class IS, class FM> inline void gatherValuesW(TA *a, const TX *x, const IS &is, FM fm)
{
    ASSERT(a && x);
    size_t j = 0;
    for (auto i : is)
 ...
 * @param is indices
 */
template <class TA, class TX, class IS> inline void gatherValuesW(TA *a, const TX *x, const IS &is)
{
 ...
 * @param is indices
 */
template <class TA, class TX, class IS> inline void gatherValuesW(vector<TA> &a, const vector<TX> &x, const IS &is)
{
 ...
 * @param is indices
 */
template <class IS> inline void gatherValuesW(vector<bool> &a, const vector<bool> &x, const IS &is)
{
    size_t j = 0;
    for (auto i : is)
        a[j++] = x[i];
 ...
 * @param fm mapping function (value)
 */
template <class TA, class TX, class IS, class FM> inline void gatherValuesOmpW(TA *a, const TX *x, const IS &is, FM fm)
{
    ASSERT(a && x);
    size_t N = is.size();
 ...
 * @param is indices
 */
template <class TA, class TX, class IS> inline void gatherValuesOmpW(TA *a, const TX *x, const IS &is)
{
    auto fm = [](const auto &v) { return v; };
 ...
 * @param is indices
 */
template <class TA, class TX, class IS> inline void gatherValuesOmpW(vector<TA> &a, const vector<TX> &x, const IS &is)
{
 ...
 * @param fm mapping function (value)
 */
template <class TA, class TX, class IS, class FM> inline void scatterValuesW(TA *a, const TX *x, const IS &is, FM fm)
{
    ASSERT(a && x);
    size_t j = 0;
    for (auto i : is)
 ...
 * @param is indices
 */
template <class TA, class TX, class IS> inline void scatterValuesW(TA *a, const TX *x, const IS &is)
{
    auto fm = [](const auto &v) { return v; };
 ...
 * @param is indices
 */
template <class TA, class TX, class IS> inline void scatterValuesW(vector<TA> &a, const vector<TX> &x, const IS &is)
{
 ...
 * @param is indices
 */
template <class IS> inline void scatterValuesW(vector<bool> &a, const vector<bool> &x, const IS &is)
{
    size_t j = 0;
    for (auto i : is)
        a[i] = x[j++];
 ...
 * @param fm mapping function (value)
 */
template <class TA, class TX, class IS, class FM> inline void scatterValuesOmpW(TA *a, const TX *x, const IS &is, FM fm)
{
    ASSERT(a && x);
    size_t N = is.size();
#pragma omp parallel for schedule(auto)
 ...
 * @param is indices
 */
template <class TA, class TX, class IS> inline void scatterValuesOmpW(TA *a, const TX *x, const IS &is)
{
    auto fm = [](const auto &v) { return v; };
 ...
 * @param is indices
 */
template <class TA, class TX, class IS> inline void scatterValuesOmpW(vector<TA> &a, const vector<TX> &x, const IS &is)
{
 ...
 * @param is indices
 */
template <class TA, class TX, class IS> inline void scatterOrW(TA *a, const TX *x, const IS &is)
{
    ASSERT(a && x);
    size_t j = 0;
    for (auto i : is)
 ...
 * @param is indices
 */
template <class TA, class TX, class IS> inline void scatterOrW(vector<TA> &a, const vector<TX> &x, const IS &is)
{
 ...
 * @param is indices
 */
template <class TA, class TX, class IS> inline void scatterOrOmpW(TA *a, const TX *x, const IS &is)
{
    ASSERT(a && x);
    size_t N = is.size();
#pragma omp parallel for schedule(auto)
 ...
 * @param is indices
 */
template <class TA, class TX, class IS> inline void scatterOrOmpW(vector<TA> &a, const vector<TX> &x, const IS &is)
{
 ...
 * @param fm mapping function (value)
 */
template <class TA, class TX, class FM> inline void valueIndicesW(vector2d<TA> &a, const vector<TX> &x, FM fm)
{
    size_t N = x.size();
 ...
 */
template <class T> inline void fillValueU(T *a, size_t N, const T &v)
{
    ASSERT(a);
    fill(a, a + N, v);
}
 ...
 * @param v value to fill
 */
template <class T> inline void fillValueU(vector<T> &a, const T &v)
{
 ...
 * @param v value to fill
 */
template <class T> inline void fillValueOmpU(T *a, size_t N, const T &v)
{
    ASSERT(a);
#pragma omp parallel for schedule(auto)
    for (size_t i = 0; i < N; ++i)
 ...
 * @param v value to fill
 */
template <class T> inline void fillValueOmpU(vector<T> &a, const T &v)
{
 ...
 */
template <class T> inline void addValueU(T *a, size_t N, const T &v)
{
    ASSERT(a);
    for (size_t i = 0; i < N; ++i)
        a[i] += v;
 ...
 * @param v value to add
 */
template <class T> inline void addValueU(vector<T> &a, const T &v)
{
 ...
 * @param v value to add
 */
template <class T> inline void addValueOmpU(T *a, size_t N, const T &v)
{
    ASSERT(a);
#pragma omp parallel for schedule(auto)
    for (size_t i = 0; i < N; ++i)
 ...
 * @param v value to add
 */
template <class T> inline void addValueOmpU(vector<T> &a, const T &v)
{
 ...
 */
template <class TA, class TX> inline void copyValuesW(TA *a, const TX *x, size_t N)
{
    ASSERT(a && x);
    for (size_t i = 0; i < N; ++i)
        a[i] = x[i];
 ...
 * @param x input vector
 */
template <class TA, class TX> inline void copyValuesW(vector<TA> &a, const vector<TX> &x)
{
 ...
 * @param N size of arrays
 */
template <class TA, class TX> inline void copyValuesOmpW(TA *a, const TX *x, size_t N)
{
    ASSERT(a && x);
#pragma omp parallel for schedule(auto)
    for (size_t i = 0; i < N; ++i)
 ...
 * @param x input vector
 */
template <class TA, class TX> inline void copyValuesOmpW(vector<TA> &a, const vector<TX> &x)
{
 ...
 * @param N size of arrays
 */
template <class TA, class TX, class TV> inline void multiplyValueW(TA *a, const TX *x, TV v, size_t N)
{
    ASSERT(a && x);
    for (size_t i = 0; i < N; ++i)
        a[i] = TA(x[i] * v);
 ...
 * @param v value to multiply
 */
template <class TA, class TX, class TV> inline void multiplyValueW(vector<TA> &a, const vector<TX> &x, TV v)
{
 ...
 * @param N size of arrays
 */
template <class TA, class TX, class TV> inline void multiplyValueOmpW(TA *a, const TX *x, TV v, size_t N)
{
    ASSERT(a && x);
#pragma omp parallel for schedule(auto)
    for (size_t i = 0; i < N; ++i)
 ...
 * @param v value to multiply
 */
template <class TA, class TX, class TV> inline void multiplyValueOmpW(vector<TA> &a, const vector<TX> &x, TV v)
{
 ...
 * @param N size of arrays
 */
template <class TA, class TX, class TY> inline void multiplyValuesW(TA *a, const TX *x, const TY *y, size_t N)
{
    ASSERT(a && x && y);
    for (size_t i = 0; i < N; ++i)
        a[i] = TA(x[i] * y[i]);
 ...
 * @param N size of arrays
 */
template <class TA, class TX, class TY> inline void multiplyValuesOmpW(TA *a, const TX *x, const TY *y, size_t N)
{
    ASSERT(a && x && y);
#pragma omp parallel for schedule(auto)
    for (size_t i = 0; i < N; ++i)
 ...
 */
template <class TX, class TA = TX> inline TA sumValues(const TX *x, size_t N, TA a = TA())
{
    ASSERT(x);
    for (size_t i = 0; i < N; ++i)
        a += TA(x[i]);
 ...
 * @returns sum of values
 */
template <class TX, class TA = TX> inline TA sumValues(const vector<TX> &x, TA a = TA())
{
 ...
 * @returns sum of values
 */
template <class TX, class TA = TX> inline TA sumValuesOmp(const TX *x, size_t N, TA a = TA())
{
    ASSERT(x);
 ...
 * @returns sum of values
 */
template <class TX, class TA = TX> inline TA sumValuesOmp(const vector<TX> &x, TA a = TA())
{
 ...
 */
template <class TX> inline size_t countValue(const TX *x, size_t N, const TX &v)
{
    ASSERT(x);
    size_t a = 0;
    for (size_t i = 0; i < N; ++i)
 ...
 * @returns number of times value appears
 */
template <class TX> inline size_t countValue(const vector<TX> &x, const TX &v)
{
 ...
 * @returns number of times value appears
 */
template <class TX> inline size_t countValueOmp(const TX *x, size_t N, const TX &v)
{
    ASSERT(x);
    size_t a = 0;
#pragma omp parallel for schedule(auto) reduction(+ : a)
 ...
 * @returns number of times value appears
 */
template <class TX> inline size_t countValueOmp(const vector<TX> &x, const TX &v)
{
 ...
 * @returns ||x||_1
 */
template <class TX, class TA = TX> inline TA l1Norm(const TX *x, size_t N, TA a = TA())
{
    ASSERT(x);
    for (size_t i = 0; i < N; ++i)
        a += TA(abs(x[i]));
 ...
 * @returns ||x||_1
 */
template <class TX, class TA = TX> inline TA l1Norm(const vector<TX> &x, TA a = TA())
{
 ...
 * @returns ||x||_1
 */
template <class TX, class TA = TX> inline TA l1NormOmp(const TX *x, size_t N, TA a = TA())
{
    ASSERT(x);
#pragma omp parallel for schedule(auto) reduction(+ : a)
    for (size_t i = 0; i < N; ++i)
 ...
 * @returns ||x||_1
 */
template <class TX, class TA = TX> inline TA l1NormOmp(const vector<TX> &x, TA a = TA())
{
 ...
 * @returns ||x-y||_1
 */
template <class TX, class TY, class TA = TX> inline TA l1NormDelta(const TX *x, const TY *y, size_t N, TA a = TA())
{
    ASSERT(x && y);
    for (size_t i = 0; i < N; ++i)
        a += TA(abs(x[i] - y[i]));
 ...
 * @returns ||x-y||_1
 */
template <class TX, class TY, class TA = TX> inline TA l1NormDeltaOmp(const TX *x, const TY *y, size_t N, TA a = TA())
{
    ASSERT(x && y);
#pragma omp parallel for schedule(auto) reduction(+ : a)
    for (size_t i = 0; i < N; ++i)
 ...
 * @returns ||x||_2
 */
template <class TX, class TA = TX> inline TA l2Norm(const TX *x, size_t N, TA a = TA())
{
    ASSERT(x);
    for (size_t i = 0; i < N; ++i)
        a += TA(x[i]) * TA(x[i]);
 ...
 * @returns ||x||_2
 */
template <class TX, class TA = TX> inline TA l2Norm(const vector<TX> &x, TA a = TA())
{
 ...
 * @returns ||x||_2
 */
template <class TX, class TA = TX> inline TA l2NormOmp(const TX *x, size_t N, TA a = TA())
{
    ASSERT(x);
#pragma omp parallel for schedule(auto) reduction(+ : a)
    for (size_t i = 0; i < N; ++i)
 ...
 * @returns ||x||_2
 */
template <class TX, class TA = TX> inline TA l2NormOmp(const vector<TX> &x, TA a = TA())
{
 ...
 * @returns ||x-y||_2
 */
template <class TX, class TY, class TA = TX> inline TA l2NormDelta(const TX *x, const TY *y, size_t N, TA a = TA())
{
    ASSERT(x && y);
    for (size_t i = 0; i < N; ++i)
 ...
 * @returns ||x-y||_2
 */
template <class TX, class TY, class TA = TX> inline TA l2NormDeltaOmp(const TX *x, const TY *y, size_t N, TA a = TA())
{
    ASSERT(x && y);
#pragma omp parallel for schedule(auto) reduction(+ : a)
    for (size_t i = 0; i < N; ++i)
 ...
 * @returns ||x||_inf
 */
template <class TX, class TA = TX> inline TA liNorm(const TX *x, size_t N, TA a = TA())
{
    ASSERT(x);
    for (size_t i = 0; i < N; ++i)
        a = max(a, TA(abs(x[i])));
 ...
 * @returns ||x||_inf
 */
template <class TX, class TA = TX> inline TA liNorm(const vector<TX> &x, TA a = TA())
{
 ...
 * @returns ||x||_inf
 */
template <class TX, class TA = TX> inline TA liNormOmp(const TX *x, size_t N, TA a = TA())
{
    ASSERT(x);
 ...
 * @returns ||x||_inf
 */
template <class TX, class TA = TX> inline TA liNormOmp(const vector<TX> &x, TA a = TA())
{
 ...
 * @returns ||x-y||_inf
 */
template <class TX, class TY, class TA = TX> inline TA liNormDelta(const TX *x, const TY *y, size_t N, TA a = TA())
{
    ASSERT(x && y);
    for (size_t i = 0; i < N; ++i)
 ...
 * @returns ||x-y||_inf
 */
template <class TX, class TY, class TA = TX> inline TA liNormDeltaOmp(const TX *x, const TY *y, size_t N, TA a = TA())
{
    ASSERT(x && y);
#pragma omp parallel for schedule(auto) reduction(max : a)
    for (size_t i = 0; i < N; ++i)
 ...
 * @returns final value
 */
template <class TA, class TX> inline TA inclusiveScanW(TA *a, const TX *x, size_t N, TA acc = TA())
{
    ASSERT(a && x);
    for (size_t i = 0; i < N; ++i)
    {
 ...
 * @returns final value
 */
template <class TA, class TX> inline TA inclusiveScanW(vector<TA> &a, const vector<TX> &x, TA acc = TA())
{
 ...
 * @returns final value
 */
template <class TA, class TX> inline TA inclusiveScanOmpW(TA *a, TA *buf, const TX *x, size_t N, TA acc = TA())
{
    ASSERT(a && x);
 ...
 * @returns final value
 */
template <class TA, class TX> inline TA exclusiveScanW(TA *a, const TX *x, size_t N, TA acc = TA())
{
    ASSERT(a && x);
    for (size_t i = 0; i < N; ++i)
    {
 ...
 * @returns final value
 */
template <class TA, class TX> inline TA exclusiveScanW(vector<TA> &a, const vector<TX> &x, TA acc = TA())
{
 ...
 * @returns final value
 */
template <class TA, class TX> inline TA exclusiveScanOmpW(TA *a, TA *buf, const TX *x, size_t N, TA acc = TA())
{
    ASSERT(a && x);
    // Each thread computes a local scan of its chunk of the input array,
    // and then the local scans are combined into a global scan.
